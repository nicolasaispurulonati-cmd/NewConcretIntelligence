 ...
 *
 * Vive acá y no en el dominio comercial por dos motivos. El catálogo también
 * cotiza y no puede depender de ventas: el modelo declara que ventas depende
 * de productos, no al revés. Y el navegador tiene que poder leer y escribir
 * importes con exactamente las mismas reglas que el servidor — `parseMoney`
 * escrito dos veces es la forma más directa de que "1.250,50" signifique dos
 * cosas distintas según de qué lado se lo mire. Ver D-015.
 */
